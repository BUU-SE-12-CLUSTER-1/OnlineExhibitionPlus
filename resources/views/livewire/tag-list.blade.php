<div>
    @livewireStyles
    <div class="search-container" style="position:relative;margin-left:1270px;margin-top:-50px;">
        <input wire:model.live="search" style="padding-left: 10px;" type="text" class="search" name="search_tag" placeholder="Search Tag">
        <button type="button" class="search-button" name="btn_search_tag" style="margin-left: 20px">
